...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] AlphaNumeric = new String[71];

        // string array for storing alphabets and numbers
        final String[] AlphaNumeric1 = new String[71];
        ...
        btnEncode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (i = 0; i < l; i++) {
                    ...
                    /*if (!found) {
                        // If the character is not found in the uppercase array,
                        // check if it exists in the lowercase array
                        for (j = 0; j < 71; j++) {
                            if (ch.equals(AlphaNumeric[j] + "*")) {
                                // concat space is used to separate
                                // the morse code of each token
                    ...
                    if (!found) {
                        // If the character is not found in either uppercase or lowercase arrays,
                        // add it as it is to the output
                        output = output.concat(ch).concat(" ");
                    }
                }
        ...
        btnDecode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*Intent insd = new Intent(MainActivity.this,MainActivity2.class);
                insd.putExtra("in",output);
                startActivity(insd);*/
            }
        });
    }
